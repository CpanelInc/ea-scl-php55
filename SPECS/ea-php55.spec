...
Patch42: php-5.5.28-systzdata-v12a.patch.centos.patch
...
%description
php 5.5 has reached End of Life.

%if %{with_httpd}
Package that installs Apache`s mod_php DSO module for PHP 5.5
%else
...
%changelog
* Wed Apr 08 2026 Brian Mendoza <brian.mendoza@webpros.com> - 5.5.38-65
- EA4-173: Mark ea-scl-php55 as EOL

* Tue Oct 14 2025 Chris Castillo <chris.castillo@webpros.com> - 5.5.38-64
- EA4-136: Fix libxml2 v2.15.0 compatibility

* Fri Sep 13 2024 Julian Brown <julian.brown@cpanel.net> - 5.5.38-63
- ZC-12167: Correct libxml2 problem

* Tue Nov 21 2023 Tim Mullin <tim@cpanel.net> - 5.5.38-62
- EA-11821: Patch to build with the latest ea-libxml2

* Wed May 17 2023 Julian Brown <julian.brown@cpanel.net> - 5.5.38-61
- ZC-10950: Fix build problems

* Wed May 10 2023 Brian Mendoza <brian.mendoza@cpanel.net> - 5.5.38-60
- ZC-10936: Clean up Makefile and remove debug-package-nil

* Wed Mar 02 2022 Travis Holloway <t.holloway@cpanel.net> - 5.5.38-59
- EA-10532: Update litespeed to 8.0.1

* Tue Dec 28 2021 Dan Muey <dan@cpanel.net> - 5.5.38-58
- ZC-9589: Update DISABLE_BUILD to match OBS

* Mon Jun 28 2021 Travis Holloway <t.holloway@cpanel.net> - 5.5.38-57
- EA-9013: Disable %check section

* Fri Mar 05 2021 Cory McIntire <cory@cpanel.net> - 5.5.38-56
...
* Fri Jul 24 2020 Tim Mullin <tim@cpanel.net> - 5.5.38-53
- EA-9189: Update litespeed from upstream to 7.7

* Thu Mar 26 2020 Tim Mullin <tim@cpanel.net> - 5.5.38-52
- EA-8928: Updated the required version for ea-libcurl

* Thu Mar 05 2020 Daniel Muey <dan@cpanel.net> - 5.5.38-51
- ZC-6270: Fix circular deps like EA-8854

* Tue Mar 03 2020 Julian Brown <julian.brown@cpanel.net> - 5.5.38-50
- ZC-6247: Deal with rpm conflicts with php-fpm and other rpms
...
* Mon Jul 08 2019 Cory McIntire <cory@cpanel.net> - 5.5.38-45
- EA-8558: Update litespeed from upstream to 7.4.2

* Fri Jun 21 2019 Tim Mullin <tim@cpanel.net> - 5.5.38-44
- EA-8538: Update litespeed from upstream to 7.4

* Thu Apr 25 2019 Daniel Muey <dan@cpanel.net> - 5.5.38-43
- ZC-5036: Add find-latest-version (assumes PHP is checked out next ro ea-tools)

* Mon Apr 22 2019 Tim Mullin <tim@cpanel.net> - 5.5.38-42
- EA-8342: Update litespeed to new upstream update of 7.3

* Tue Apr 16 2019 Tim Mullin <tim@cpanel.net> - 5.5.38-41
- EA-8342: Update litespeed to 7.3

* Fri Jan 25 2019 Cory McIntire <cory@cpanel.net> - 5.5.38-40
...
* Fri Jan 19 2018 <darren@cpanel.net> - 5.5.38-33
...
* Tue Sep 26 2017 Dan Muey <dan@cpanel.net> - 5.5.38-25
- EA-6819: Patch to support libtidy 5.4.0

* Wed Aug 16 2017 Dan Muey <dan@cpanel.net> - 5.5.38-24
...
* Tue May 16 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.38-19
- EA-6282: Swapped ea-php## symlinks to match EasyApache 3 compatibility

* Tue May 09 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.38-18
- Switch libxml2 to cPanel distributed packages

* Fri May 05 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.38-17
- EA-6063: Add ea-php55 binary symlinks to /usr/bin and /usr/local/bin

* Tue Apr 25 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.38-16
- Disable dtrace functionality since CentOS does not provide dtrace via repos.

* Fri Apr 21 2017 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.38-15
- EA-6203: Correct OpCache blacklist directory

* Tue Mar 28 2017 Dan Muey <dan@cpanel.net> - 5.5.38-14
...
* Fri Nov 18 2016 Matt Dees <matt.dees@cpanel.net> 5.5.38-7
- Fix erronous getpwnam message in php-fpm jailshell code

* Fri Nov 18 2016 S. Kurt Newman <kurt.newman@cpanel.net> - 5.5.38-6
- Ensure the same extensions are compiled statically across all
  SAPI types (EA-5587)

* Thu Nov 17 2016 Edwin Buck <e.buck@cpanel.net> 5.5.38-5
- Make php-cli require php-litespeed

* Wed Sep 28 2016 Jacob Perkins <jacob.perkins@cpanel.net> 5.5.38-4
...
* Fri Apr 01 2016 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.34-1
- Updated to version 5.5.34 via update_pkg.pl (EA-4397)
...
* Thu Dec 17 2015 S. Kurt Newman <kurt.newman@cpanel.net> - 5.5.30-7
- mod_php requires a non-threaded Apache mpm (EA-3982)

* Thu Dec 17 2015 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.30-6
- Enabled short_open_tags (ZC-1284)

* Fri Dec 11 2015 S. Kurt Newman <kurt.newman@cpanel.net> - 5.5.30-5
- Disable ZTS support (EA-3791)
...
- Rename www.conf to www.conf.example (ZC-1205)

* Mon Oct 12 2015 Dan Muey <dan@cpanel.net> - 5.5.30-2
- Use libphp5.so as module name for simplicity/consistency (EA-3750)

* Thu Oct 01 2015 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.30-1
- Updated to version 5.5.30 via update_pkg.pl

* Fri Sep 04 2015 Jacob Perkins <jacob.perkins@cpanel.net> - 5.5.29-1
- Updated to version 5.5.29 via update_pkg.pl

* Tue Sep 01 2015 Kurt Newman <kurt.newman@cpanel.net> - 5.5.28-1
- Updated to version 5.5.28 via update_pkg.pl

* Thu Aug 06 2015 Trinity Quirk <trinity.quirk@cpanel.net> - 5.5.22-6
